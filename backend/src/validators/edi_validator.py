...
def validate_hipaa_structure(filepath, output_json="validation_errors.json"):
    ...
    if "ERROR" not in errors and result:
        ...
        for i, line in enumerate(error_lines):
            ...
            # Clean up generic file errors for the UI
            if "does not look like an X12 data file" in msg:
                msg = "Structural Error: This file does not appear to be a valid X12 EDI document. Please check the ISA start segment."
